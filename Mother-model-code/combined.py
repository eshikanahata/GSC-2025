...
API_KEY = "AIzaSyD7P0g7cyFfdhLxBJ3RayolCsJt6EJfh54"  # Replace with your actual YouTube API key
...
async def load_models():
    ...
    tamil_model = PeftModel.from_pretrained(tamil_model, "sahithimacharapu/tamil-model")
    ...
    kannada_model = PeftModel.from_pretrained(kannada_model, "sahithimacharapu/kannada-model")
    ...
    malayalam_model = PeftModel.from_pretrained(malayalam_model, "sahithimacharapu/malayalam-model")
...
async def process_comments():
    ...
    while True:
        ...
        if classification == "Hate":
            if comment_entry not in stored_comments:
                stored_comments.append((comment, language, classification))
